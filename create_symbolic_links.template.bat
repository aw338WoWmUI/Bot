...
if exist "%path%\_retail_" (
	...
	mklink /D "%path%\_retail_\Interface\AddOns\Modules" "%~dp0\AddOns\Modules"
...
if exist "%path%\_classic_" (
	...
	mklink /D "%path%\_classic_\Interface\AddOns\Modules" "%~dp0\AddOns\Modules"
	...
	mklink /D "%path%\_classic_\Interface\AddOns\RecommendedSpellCaster" "%~dp0\AddOns\RecommendedSpellCaster"
...
if exist "%path%\_classic_era_" (
	...
	mklink /D "%path%\_classic_era_\Interface\AddOns\Modules" "%~dp0\AddOns\Modules"
	...
	mklink /D "%path%\_classic_era_\Interface\AddOns\RecommendedSpellCaster" "%~dp0\AddOns\RecommendedSpellCaster"
